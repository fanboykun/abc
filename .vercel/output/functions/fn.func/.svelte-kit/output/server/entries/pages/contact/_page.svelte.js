import { c as create_ssr_component, v as validate_component, b as add_attribute, e as escape } from "../../../chunks/index2.js";
import { a as socials, S as Saos } from "../../../chunks/Saos.js";
...
<div class="sm:px-8 mt-16 sm:mt-18"><div class="mx-auto max-w-7xl lg:px-8"><div class="relative px-4 sm:px-8 lg:px-12"><div class="mx-auto max-w-2xl lg:max-w-5xl"><h1 class="text-4xl font-mono font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl"><p>Get In Touch With Me, Discuss Anything.
				...
				<div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">${validate_component(Saos, "Saos").$$render(
    $$result,
    {
      ...
      default: () => {
        return `<div class="lg:order-first lg:row-span-2"><div class="rounded-2xl border border-zinc-100 dark:border-zinc-700/40 p-6 mt-8"><h2 class="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 fill-zinc-100 stroke-zinc-400 dark:fill-zinc-100/10 dark:stroke-zinc-500"><path fill-rule="evenodd" d="M4.848 2.771A49.144 49.144 0 0112 2.25c2.43 0 4.817.178 7.152.52 1.978.292 3.348 2.024 3.348 3.97v6.02c0 1.946-1.37 3.678-3.348 3.97a48.901 48.901 0 01-3.476.383.39.39 0 00-.297.17l-2.755 4.133a.75.75 0 01-1.248 0l-2.755-4.133a.39.39 0 00-.297-.17 48.9 48.9 0 01-3.476-.384c-1.978-.29-3.348-2.024-3.348-3.97V6.741c0-1.946 1.37-3.68 3.348-3.97zM6.75 8.25a.75.75 0 01.75-.75h9a.75.75 0 010 1.5h-9a.75.75 0 01-.75-.75zm.75 2.25a.75.75 0 000 1.5H12a.75.75 0 000-1.5H7.5z" clip-rule="evenodd"></path></svg>
							...
							<ol class="mt-6 space-y-4"><li class="flex gap-4"><form action="" method="POST" class="flex flex-auto flex-wrap gap-x-2"><div class="relative z-0 w-full mb-6 group"><input type="text" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer" placeholder=" " required${add_attribute("value", name, 0)}>
										...
										<div class="relative z-0 w-full mb-6 group"><input type="text" name="subject" id="subject" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer" placeholder=" " required${add_attribute("value", subject, 0)}>
											<label for="subject" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-teal-600 peer-focus:dark:text-teal-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Message subject</label></div>
										<div class="relative z-0 w-full mb-6 group"><textarea rows="4" name="message" id="message" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer" placeholder=" " required>${""}</textarea>
											<label for="message" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-teal-600 peer-focus:dark:text-teal-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Your message</label></div>
										<div class="flex w-auto"><button type="submit" ${loading.status ? "disabled" : ""} class="inline-flex w-full justify-center rounded-md bg-teal-600 hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-700 px-4 py-2 text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto">Send</button>
											${loading.message != null ? `<span class="ml-2 flex w-full my-auto text-teal-800 font-bold">${escape(loading.message)}</span>` : ``}</div></form></li></ol></div></div>`;
      }
    }
  )}
                    <div class="lg:pl-20 mt-8"><ul><li class="flex"><span class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500">${validate_component(Saos, "Saos").$$render(
    $$result,
    {
    ...
    {
      default: () => {
        return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500"><path fill-rule="evenodd" d="M9.69 18.933l.003.001C9.89 19.02 10 19 10 19s.11.02.308-.066l.002-.001.006-.003.018-.008a5.741 5.741 0 00.281-.14c.186-.096.446-.24.757-.433.62-.384 1.445-.966 2.274-1.765C15.302 14.988 17 12.493 17 9A7 7 0 103 9c0 3.492 1.698 5.988 3.355 7.584a13.731 13.731 0 002.273 1.765 11.842 11.842 0 00.976.544l.062.029.018.008.006.003zM10 11.25a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" clip-rule="evenodd"></path></svg>`;
      }
    }
  )}
									<span class="ml-4">Medan, Sumatera Utara. Indonesia</span></span></li>
							<li class="mt-8 flex border-t border-zinc-100 pt-8 dark:border-zinc-700/40"><a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"${add_attribute("href", twitter[0].link, 0)}>${validate_component(Saos, "Saos").$$render(
    $$result,
    {
  ...
  )}<span class="ml-4">Follow on Instagram @${escape(instagram[0].username)}</span></a></li>
							<li class="mt-4 flex"><a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"${add_attribute("href", github[0].link, 0)}>${validate_component(Saos, "Saos").$$render(
    $$result,
    {
  ...
  )}<span class="ml-4">Follow on GitHub @${escape(github[0].username)}</span></a></li>
							<li class="mt-4 flex"><a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"${add_attribute("href", linkedin[0].link, 0)}>${validate_component(Saos, "Saos").$$render(
    $$result,
    {
      animation: "roll-in-blurred-left 0.65s cubic-bezier(0.230, 1.000, 0.320, 1.000) 1s both",
      once: true
    },
    {},
    {
      default: () => {
        return `<svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500"><path d="M18.335 18.339H15.67v-4.177c0-.996-.02-2.278-1.39-2.278-1.389 0-1.601 1.084-1.601 2.205v4.25h-2.666V9.75h2.56v1.17h.035c.358-.674 1.228-1.387 2.528-1.387 2.7 0 3.2 1.778 3.2 4.091v4.715zM7.003 8.575a1.546 1.546 0 01-1.548-1.549 1.548 1.548 0 111.547 1.549zm1.336 9.764H5.666V9.75H8.34v8.589zM19.67 3H4.329C3.593 3 3 3.58 3 4.297v15.406C3 20.42 3.594 21 4.328 21h15.338C20.4 21 21 20.42 21 19.703V4.297C21 3.58 20.4 3 19.666 3h.003z"></path></svg>`;
							...
							<li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex"><a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"${add_attribute("href", emailIcon[0].link, 0)}>${validate_component(Saos, "Saos").$$render(
    $$result,
    {
      animation: "roll-in-blurred-left 0.65s cubic-bezier(0.230, 1.000, 0.320, 1.000) 1.2s both",
      once: true
    },
    {},
    {
      default: () => {
        return `<svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500"><path fill-rule="evenodd" d="M6 5a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H6Zm.245 2.187a.75.75 0 0 0-.99 1.126l6.25 5.5a.75.75 0 0 0 .99 0l6.25-5.5a.75.75 0 0 0-.99-1.126L12 12.251 6.245 7.187Z"></path></svg>`;
									...
									<span class="ml-4">${escape(emailIcon[0].username)}</span></a></li></ul></div></div></div></div></div></div>`;
});
export {
  Page as default
};
