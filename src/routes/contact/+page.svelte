                                ...
                                <li class="flex gap-4">
                                    <form action="" method="POST" on:submit|preventDefault={sendMessage} class="flex flex-auto flex-wrap gap-x-2">
                                        ...
                                        <div class="flex w-auto">
                                            <button type="submit" class="inline-flex w-full justify-center rounded-md bg-teal-600 hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-700 px-4 py-2 text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto">Send</button>
                                            {#if loading.message != null}
                                            <span class=" ml-2 block my-auto text-teal-800 font-bold">
                                                {loading.message}
                                            </span>
                                            {/if}
                                        </div>
