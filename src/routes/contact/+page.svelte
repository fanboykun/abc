						...
						<ul>
							<li class="flex">
								<span class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500">
									...
									<span class="ml-4">Medan, Sumatera Utara. Indonesia</span>
								</span>
							</li>
							<li class="mt-8 flex border-t border-zinc-100 pt-8 dark:border-zinc-700/40">
								<a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="{twitter[0].link}">
									<Saos animation={'roll-in-blurred-left 0.65s cubic-bezier(0.230, 1.000, 0.320, 1.000) 0.4s both'} once={true}>
									<svg
										viewBox="0 0 24 24"
										aria-hidden="true"
										...
										/></svg></Saos>
									<span class="ml-4">Follow on Twitter @{twitter[0].username}</span>
								</a>
							</li>
							<li class="mt-4 flex">
								<a
